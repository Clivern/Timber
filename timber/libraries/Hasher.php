...
/**
 * Portable php password hashing based on phpass class
 *
 * A little check to ensure that phpass working on your server
 * <code>
 * 	$pwd_hash = \Timber\Libraries\PwdHash::instance();
 *  	$pwd_hash->config(8, FALSE);
 * 	$pwd = "$0106323098";
 * 	$hash = $pwd_hash->HashPassword($pwd);
 * 	echo "------- HASH -------\n";
 * 	echo $hash . "\n";
 * 	$check = $pwd_hash->CheckPassword($pwd, $hash);
 * 	echo "------- CHECK -------\n";
 * 	var_dump($check);
 * </code>
 *
...
class Hasher {
	 ...
	 * @access public
	 */
	public function config($iteration_count_log2, $portable_hashes)
	{
